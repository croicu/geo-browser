...
completed-task entry ([geo-browser#77](https://github.com/croicu/geo-browser/issues/77)). Kept in sync the same way `MESSAGING.md` is.
...
(`voidLayerView.ts` / `voidSpatialIndex.ts`, see [geo-browser#77](https://github.com/croicu/geo-browser/issues/77)). Two problems surfaced
...
- **Faded edge (implemented, 2026-07-12):** the polygon renders into a dedicated Leaflet pane
  ...
  visible fog at all the first time this exact mistake was made (see [geo-browser#77](https://github.com/croicu/geo-browser/issues/77)'s
